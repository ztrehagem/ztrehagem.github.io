  ...
  <div class="space-y-16">
    <section class="space-y-8 leading-loose">
      ...
      <table>
        <tbody>
          <tr>
            <th scope="row" class="pr-8 align-top text-left whitespace-no-wrap">
              2000年代初頭
            </th>
            <td>
              <p>
                FLASH、Java
                Applet、ブラウザゲー、隠しページ・・・などが跋扈していたインターネットの世界に爆誕。
              </p>
              <p>
          ...
          <tr>
            <th
              scope="row"
              class="pt-8 pr-8 align-top text-left whitespace-no-wrap"
            ></th>
            <td class="pt-8">
              <p>
          ...
          <tr>
            ...
            <td class="pt-8">
              <p>
                DTMサークルを立ち上げ、楽曲制作とアルバムCDの企画・制作進行を担う。
              </p>
              <p>
