<template>
  <div class="space-y-16">
    <section class="space-y-8 leading-loose">
      <h2 class="text-6xl leading-tight font-kanit">
      ...
      <p>
        Webアプリケーションフロントエンドの実装を得意としており、業務では主に
        JavaScript/TypeScript + Vue.js/Nuxt.js
        による環境構築～設計～実装を担当している。OpenAPI
        を利用したコード自動生成ツールの作成をはじめ、開発効率化への貢献も積極的に行っている。
      </p>
      <p>
        CSSについても一通り理解があり、CSSアニメーションの実装や、カルーセルやアコーディオン等JSが絡んだ複雑なUIの実装も行う。
      </p>
      <p>
        大学で学んだ知識や趣味で制作しているアプリケーションの経験から、サーバサイド・インフラ・ネットワーク等についても知識・経験があり、Webアプリケーション全体について議論することができる。
      </p>

      <dl>
        <dt class="font-bold underline">得意</dt>
        <dd class="ml-4">
          JavaScript, TypeScript, Vue.js, Nuxt.js, Node.js, CSS3, Sass, Stylus,
          HTML5
        </dd>

        <dt class="font-bold underline">まあ分かる</dt>
        <dd class="ml-4">
          Java, C/C++, Swift, SwiftUI, Ruby, Ruby on Rails, Docker, Vagrant,
          DB/SQL, Firebase
        </dd>

        <dt class="font-bold underline">触ったことはある</dt>
        <dd class="ml-4">
          Go, Lisp(Scheme), Haskell, Lambda Calculus, GCP, Deno
        </dd>
      </dl>
    </section>
      ...
      >
        <li class="m-2">
          <a href="https://teikyou.com/" class="block">
            <figure>
              <img
                src="~@/assets/images/thumbnails/teikyou-dot-com.png"
                alt="thumbnail"
        ...
        <li class="m-2">
          <a href="https://ztrehagem.dev/" class="block">
            <figure>
              <img
                src="~@/assets/images/ztrehagem.png"
                alt="thumbnail"
                class="h-64 w-auto max-w-full"
              />
      ...
      <ul class="list-disc pl-6 space-y-4">
        <li>
          <dl>
            <dt>
              <a
                href="https://www.npmjs.com/package/@ztrehagem/openapi-codegen-typescript"
              >
                <link-text>@ztrehagem/openapi-codegen-typescript</link-text>
              </a>
              <span>
                <span>(</span>
                <a
                  href="https://github.com/ztrehagem/openapi-codegen-typescript"
                >
                  <link-text>GitHub</link-text>
                </a>
                <span>)</span>
            ...
            <dd>
              OpenAPI
              ドキュメントからTypeScriptコードを自動生成するやつ。レスポンスのHTTPステータス毎に型定義されるのが特徴。README書いてなくてすみません。
            </dd>
          </dl>
        </li>
        ...
        <li>
          <dl>
            <dt>
              <a href="https://www.npmjs.com/package/@ztrehagem/vue-accordion">
                <link-text>@ztrehagem/vue-accordion</link-text>
              </a>
              <span>
                <span>(</span>
                <a href="https://github.com/ztrehagem/vue-accordion">
                  <link-text>GitHub</link-text>
                </a>
                <span>)</span>
              </span>
        ...
        <li>
          <dl>
            <dt>
              <a href="https://www.npmjs.com/package/@ztrehagem/daty">
                <link-text>@ztrehagem/daty</link-text>
              </a>
              <span>
                <span>(</span>
                <a href="https://github.com/ztrehagem/daty">
                  <link-text>GitHub</link-text>
                </a>
                <span>)</span>
              </span>
    ...
    <section class="space-y-8 leading-loose">
      ...
      <ul class="list-disc pl-6 space-y-4">
        ...
        <li>
          <dl>
            <dt>
              Liquid: A concurrent calculus with declaring first-order
        ...
        <li>
          <dl>
            <dt>
              対話を行う分散ロボットによる迷子探索システム
              (クラウドネットワークロボット)
            </dt>
            <dd>
              電子情報通信学会技術研究報告 = IEICE technical report : 信学技報
              117(198):2017.9.1 p.19-24
            </dd>
          </dl>
        </li>
      </ul>
